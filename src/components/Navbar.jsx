            ...
            <div className='flex justify-between items-center m-4'>
                ...
                <div className={nav ? 'fixed z-index-[100] top-0 left-0 w-[70%] min-h-[100vh] border-r border-r-sky-400 bg-slate-900 duration-500 ' : 'fixed left-[-100%] duration-700'}>
                    ...
                    <ul className='font-bold block text-lg px-12  [&_li]:focus:text-sky-500 cursor-pointer'>
                        ...
                        <li onClick={() => handleNav()} ><a className='flex gap-4 items-center py-3 my-4 mx-6 px-2 border-l-[3px] rounded-sm hover:border-l-[3px] duration-200 transition-all border-l-orange-400' href='#project'>Projects <AiFillProject size={25} className='max-sm:size-25' git add ./></a></li>
